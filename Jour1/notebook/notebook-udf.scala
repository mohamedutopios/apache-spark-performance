...
val startTimeD = System.currentTimeMillis()
...
val endTimeD = System.currentTimeMillis()
val executionTimeD = endTimeD - startTimeD
println(s"Step D executed in $executionTimeD milliseconds")

// COMMAND ----------

sc.setJobDescription("Step E: UDFs")

val startTimeE = System.currentTimeMillis()
...
val endTimeE = System.currentTimeMillis()
val executionTimeE = endTimeE - startTimeE
println(s"Step E executed in $executionTimeE milliseconds")
